...
- Increased the yield of Gold Nuggets from Nether Gold Ore blocks.
- Altered the weights of the rewards of bartering so that essential items drop more frequently than trash ones.

## Building

Building is done manually. Zip the contents *inside* the `data_pack` folder and add `pack.png` to it, and zip the contents *inside* the `resource_pack` folder and add `pack.png` to it, do not add the folders themselves. Additionally, you can also symlink the folders.

Made by hibi. Licensed under MIT.
